...
if (empty($_FILES) === false) {
	...
	if($src_w>800)resizeimage($file_path,800,800/$src_w*$src_h,$save_path.$new_file_name_without_ext.'.jpg');
	else resizeimage($file_path,$src_w,$src_h,$save_path.$new_file_name_without_ext.'.jpg');
