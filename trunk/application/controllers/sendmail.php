		...
		foreach ($all_member_information as $member_information){
			...
			foreach ($all_attend_information as $attendance){
				...
				if ($activity_information) {
					$mail.='您报名的活动<a href="'.site_url("activity/view/").$activity_information['activity_id'].'">'.$activity_information['activity_name'].'</a>将于'.$activity_information['start_time'].'开始<br/>';
