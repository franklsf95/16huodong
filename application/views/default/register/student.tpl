	...
	<div class="detail_information">
		<div id="detail_student">
			<form class="detail_form" action="__('register/save_detail_information'|site_url)__" method="post">
				<fieldset>
					<div class="left">
						<p><label>组织:</label><input type="text" name="organisation" /></p>
						<p><label>职务:</label><input type="text" name="title" /></p>
					...
					<div class="right">
						...
						<p><label>性别:</label><select name="gender"><option value="M">男</option><option value="F">女</option></select></p>
						<p><label>生日:</label><input type="text" name="birthday" id="birthday" value="1990-01-01" readonly="readonly" /></p>
