...
+'<a class="waterfall-item-heading" href="{"activity/view"|site_url}/'+act.activity_id+'">'+act.activity_name+'</a>'
+'<ul>'
...
+'<div class="waterfall-item-bottom">'
+'<a class="waterfall-item-heading" href="{"library/view"|site_url}/'+book.book_id+'">'+book.book_name+'</a>'
+'<ul>'
